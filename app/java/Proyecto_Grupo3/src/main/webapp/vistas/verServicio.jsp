                ...
                <div class="servicio-grid">
                    ...
                    <div class="servicio-col">
                        <div class="servicio-grupo">
                            ...
                            <span class="servicio-valor"><c:out
                                    value="${servicio.categoria}"></c:out></span>
                        </div>

                        <div class="servicio-grupo">
                            <span class="servicio-label">Sede</span>
                            <span class="servicio-valor"><c:out
                                    value="${servicio.sede}"></c:out></span>
                        </div>

                        <div class="servicio-grupo">
                            <span class="servicio-label">Tecnologías
                                implicadas</span>
                            <div class="servicio-caja servicio-caja-md">
                                <c:out
                                    value="${servicio.tecnologiasImplicadas}"></c:out>
                            </div>
                        </div>
                        ...
                        <div class="servicio-meta">
                            <strong>Fecha:</strong> <c:out
                                value="${servicio.fechaCreacion}"></c:out> <br>
                            <strong>Estado:</strong> <c:out
                                value="${servicio.estado ? 'Activo' : 'Inactivo'}"></c:out>
                        </div>
                    </div>
                ...
                <c:choose>
                    <c:when test="${rol == 'admin'}">
                        <div class="servicio-pie">
                            <a href="${pageContext.request.contextPath}/GestionServicioControlador?opcion=listarServicios&funcion=servicio"
                                class="btn-secondary servicio-btn-cerrar">Cerrar</a>
                        </div>
                    </c:when>
                    <c:otherwise>
                        <div class="servicio-pie">
                            <a href="${pageContext.request.contextPath}/IndexControlador"
                                class="btn-secondary servicio-btn-cerrar">Cerrar</a>
                        </div>
                    </c:otherwise>
                </c:choose>
